...
sealed class OnboardingHourlyForecastViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {

    class HourlyWeatherForecastViewHolder(
        private val binding: ItemHourlyForecastOnboardingBinding
    ): OnboardingHourlyForecastViewHolder(binding.root) {
        ...
        fun bind(hourlyWeather: HourlyWeather, heightMultiplier: Float, isNow: Boolean = false) {
            binding.apply {
                if (isNow) {
                    hourTextView.setTextColor(root.context.getColor(R.color.white))
    ...
    class HourlyWeatherForecastDayDivider(binding: ItemHourlyForecastDayDividerOnboardingBinding): OnboardingHourlyForecastViewHolder(binding.root)
}