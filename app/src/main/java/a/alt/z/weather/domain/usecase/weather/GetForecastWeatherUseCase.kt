...
): UseCase<Location, ForecastWeather>(coroutineDispatcher) {

    override suspend fun execute(parameters: Location): ForecastWeather {
        return repository.getForecastWeather(parameters)
    }
}